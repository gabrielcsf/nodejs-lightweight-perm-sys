...
Module.prototype._compile = function(content, filename) {
  ...
  // var gglobal = membrane.create(global, "global-" + sourceModule);
  ...
  // var compiledWrapper = vm.runInSameContext(wrapper, sandbox);
  ...
  require = Module.wrapRequire(require, "require", sourceModule, dirname);
