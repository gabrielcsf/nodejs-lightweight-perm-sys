...
(function(process) {
  ...
  function startup() {
    ...
    if (NativeModule.exists('_third_party_main')) {
      ...
      if (process._eval != null && !process._forceRepl) {
        ...
        //     console.log('>>>>> [GET ON GLOBAL OBJECT] -> ' + String(prop));
        //     return obj[prop];
        //   },
        ...
        const console = NativeModule.require('console');
        process.argv[1] = path.resolve(process.argv[1]);

        // ----------------------------------------------------------------------------
        // Loading package's permissions
        // ----------------------------------------------------------------------------
        // console.log(">>>> Loading package.json for: " + process.argv[1]);
        // var manifestFile = path.resolve(".") + "/package.json";
        ...
        // } else {
        //   console.log("The manifest file for the " + process.argv[1] + " file does not exist");
        // }
        ...
        //   },
        //   set(obj, prop, value) {
        //     console.log('>>>>> [SET ON GLOBAL OBJECT] -> ' + String(prop));
  ...
  NativeModule.require = function(id) {
    ...
    var nativeExports = nativeModule.exports;
  ...
  NativeModule.prototype.compile = function() {
    ...
    var nativeRequire = NativeModule.require
    this.loading = true;
    ...
    try {
      ...
      fn(this.exports, nativeRequire, this, this.filename);
